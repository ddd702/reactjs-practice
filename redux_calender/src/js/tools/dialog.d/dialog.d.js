...
(function(global) {
    ...
    D.dialog = {
        tpl: {
            alert: '<div class="d-dialog-cell"><p class="d-dialog-title"><&=title&></p><div class="d-dialog-con"><&=content&></div><div class="d-dialog-btn"><a href="javascript:" class="btn" id="D-alert-y"><&=btn&></a></div></div> ',
            confirm: '<div class="d-dialog-cell"><p class="d-dialog-title"><&=title&></p><div class="d-dialog-con"><&=content&></div><div class="d-dialog-btns"><a href="javascript:" class="btn" id="D-confirm-y"><&=btnY&></a><a href="javascript:" class="btn" id="D-confirm-n"><&=btnN&></a></div></div>',
            prompt: '<div class="d-dialog-cell"><p class="d-dialog-title"><&=title&></p><div class="d-dialog-con"><&=content&></div><input class="d-dialog-input" type="<&=inputType&>" value="<&=defaultVal&>"><div class="d-dialog-btns"><a href="javascript:" class="btn" id="D-prompt-y"><&=btnY&></a><a href="javascript:" class="btn" id="D-prompt-n"><&=btnN&></a></div></div>',
            notify: '<div class="d-notify-cell"><span class="d-notify-con"><&=content&></span></div>',
            modal:'<div class="d-modal-cell"><span class="d-modal-close">X</span><div class="d-modal-header"><&=header&></div><div class="d-modal-content"><&=content&></div></div>'
        },
        config: {
            alert: {
                title: '',
            ...
            notify: {
                ...
                pos:'mid',//top:顶部，mid:居中，bottom:底部
                fn: function() {} //同时执行的回调
            }
        },
        test: function() {
    ...
    D.notify = function(con, param) {
        ...
        if (!notifyEle) {
            ...
            notifyEle.className = opt.operate ? 'd-show d-notify-'+opt.pos : 'd-dialog-box d-show d-notify-'+opt.pos;
        ...
        if (opt.autoRm) {
            ...
            D.dialog.notifyTimer = setTimeout(function() {
                notifyEle.className = opt.operate ? 'd-hide d-notify-'+opt.pos : 'd-dialog-box d-hide d-notify-'+opt.pos;
            }, opt.rmTime);
        }
    };
    D.rmNotify = function() {
